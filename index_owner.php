...
<head>
    ...
    <style>
        ...
        header {
            ...
            padding: 20px 0;
            text-align: center;
            position: relative; /* Positioning for the logout link */
        }
        .logout {
...
<nav>
    ...
    <a href="all_eompoloyee_salary.php">all empoloyee salary</a> 
    <a href="backend%20data/check_all_emoloye_salary_slip.php">Check all Empoloyee salary slip</a> 
    <a href="attendance_data/attendance_data.php">Attendance_Data</a>
    <a href="backend%20data/fetch_material_data.php">Stock Update</a>
</nav>
