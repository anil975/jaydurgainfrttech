...
// Assuming these are your employee names from the database
$employees = [
    "pramod", "vindesari", "rajendra bhagat", "manu kumar", "Ashish Kumar",
    "mantu kumar", "santosh", "brijesh", "harikesh", "rajkumar","viruram","sanjay","babujan","amit","visarath","vijay","sunil maurya","lal bahadur","prem sagar"
];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO attendance (employee_name, date, status, time_in) VALUES ('$employee_name', '$date', '$status', '$time_in')";
...
<head>
    ...
    <style>
        ...
        select {
            height: 35px; /* Reduced height for select fields */
        }
...
<div class="container">
    ...
    <form method="POST" action="attendance.php">
        ...
        <table>
            ...
            <tr>
                <td>Date:</td>
                <td><input type="date" id="date" name="date" required></td> <!-- Set current date -->
            </tr>
            <tr>
                <td>Status:</td>
                <td>
            ...
            <tr>
                <td>Time In:</td>
                <td><input type="text" id="time_in" name="time_in" value="<?php echo date('H:i', time() + 5 * 3600 + 30 * 60); ?>" readonly></td> <!-- Set IST -->
            </tr>
        </table>
